...
function VerifyExitSendVerificationCodeModalContent() {
  ...
  return (
    <View className="gap-y-2">
      ...
      <Text className="text-funBlue font-medium text-lg justify-center">
        Hesap onayı ekranından çıkmak istediğinize emin misiniz ?
      </Text>
...
export default VerifyExitSendVerificationCodeModalContent;
